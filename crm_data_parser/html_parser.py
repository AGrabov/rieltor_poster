...
CRM_TYPE_TO_SCHEMA = {
    ...
    "земля під інд. будівництво": "Ділянка",
    "земля під індивідуальне будівництво": "Ділянка",
    "земля сільгосппризначення": "Ділянка",
    "земля комерційного призначення": "Ділянка",
    "земля під сад, город": "Ділянка",
    "земля під сад": "Ділянка",
    # Паркомісце subtypes
